 ...
 *
 * Reads the authors list, checks each author's feed for their latest entry,
 * loads local post sidecars for preview data, regenerates the homepage HTML,
 * uploads it, and updates the homepage feed.
 *
 * Run this after one or more authors have published new posts:
