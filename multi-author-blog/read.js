/**
 * read.js — Read the multi-author blog without private keys.
 *
 * Demonstrates that any third party can discover all authors and
 * read their feeds using only the index feed manifest hash.
