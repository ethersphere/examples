/**
 * init.js — One-time blog setup
 *
 * Generates keys for admin, Alice, and Bob. Creates feeds and feed manifests
 * for each author plus the index and homepage feeds. Builds the initial
 * authors.json index and saves all keys and manifest hashes to config.json.
 *
 * Run once before using any other script:
 *   node init.js
 */
